...
> __Внимание__
> Текста всё еще добавляются. Если здесь нет нужной вам песни - подождите, перед тем как создавать issue. Список будет готов хотя-бы на 100 текстов, когда это сообщение исчезнет.
